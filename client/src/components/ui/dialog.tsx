...
function DialogPortal({
  ...
  // Render portal inside #root so React event delegation works correctly
  const portalContainer = container || (typeof document !== 'undefined' ? document.getElementById('root') : undefined) || undefined;
