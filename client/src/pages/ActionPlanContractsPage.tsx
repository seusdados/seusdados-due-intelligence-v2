...
export default function ActionPlanContractsPage() {
  ...
  // Carregar apenas planos de ação de Contratos
  const { data: actionsData, refetch } = trpc.actionPlan.listByType.useQuery(
    { organizationId: selectedOrganization?.id || 0, assessmentType: 'contract_analysis' },
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-slate-900">
                Plano de Ação – Análise de Contratos
              </h1>
            </div>
            <p className="text-slate-600">
              Ações originadas de análises contratuais LGPD/ANPD
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="bg-white border-slate-200">
            <CardContent className="pt-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">{stats.pendentes}</div>
        ...
        <div className="space-y-4">
          {filteredActions.length === 0 ? (
            ...
            filteredActions.map(action => (
              <Card key={action.id} className="bg-white border-slate-200 hover:border-blue-300 transition-colors">
                <CardContent className="pt-6">
